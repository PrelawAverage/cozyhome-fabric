...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE)
                ...
                // FOUNTAIN SPROUTS
                .add(ModBlocks.STONE_BRICK_FOUNTAIN_SPOUT)
                .add(ModBlocks.MOSSY_STONE_BRICK_FOUNTAIN_SPOUT)
                .add(ModBlocks.GRANITE_FOUNTAIN_SPOUT)
                .add(ModBlocks.DIORITE_FOUNTAIN_SPOUT)
                .add(ModBlocks.ANDESITE_FOUNTAIN_SPOUT)
                .add(ModBlocks.DEEPSLATE_FOUNTAIN_SPOUT)
                .add(ModBlocks.CALCITE_FOUNTAIN_SPOUT)
                .add(ModBlocks.TUFF_FOUNTAIN_SPOUT)
                .add(ModBlocks.BRICK_FOUNTAIN_SPOUT)
                .add(ModBlocks.MUD_FOUNTAIN_SPOUT)
                .add(ModBlocks.SANDSTONE_FOUNTAIN_SPOUT)
                .add(ModBlocks.RED_SANDSTONE_FOUNTAIN_SPOUT)
                .add(ModBlocks.PRISMARINE_FOUNTAIN_SPOUT)
                .add(ModBlocks.NETHER_BRICK_FOUNTAIN_SPOUT)
                .add(ModBlocks.RED_NETHER_BRICK_FOUNTAIN_SPOUT)
                .add(ModBlocks.BLACKSTONE_FOUNTAIN_SPOUT)
                .add(ModBlocks.ENDSTONE_FOUNTAIN_SPOUT)
                .add(ModBlocks.PURPUR_FOUNTAIN_SPOUT)
        ;
