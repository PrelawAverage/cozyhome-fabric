...
public class ModFuels {
    public static void registerFuels() {
        ...
        FuelRegistry.INSTANCE.add(ModBlocks.OAK_TOOL_RACK, 100);
        FuelRegistry.INSTANCE.add(ModBlocks.SPRUCE_TOOL_RACK, 100);
        FuelRegistry.INSTANCE.add(ModBlocks.BIRCH_TOOL_RACK, 100);
        FuelRegistry.INSTANCE.add(ModBlocks.JUNGLE_TOOL_RACK, 100);
        FuelRegistry.INSTANCE.add(ModBlocks.ACACIA_TOOL_RACK, 100);
        FuelRegistry.INSTANCE.add(ModBlocks.DARK_OAK_TOOL_RACK, 100);
        FuelRegistry.INSTANCE.add(ModBlocks.MANGROVE_TOOL_RACK, 100);
        FuelRegistry.INSTANCE.add(ModBlocks.CHERRY_TOOL_RACK, 100);
        FuelRegistry.INSTANCE.add(ModBlocks.BAMBOO_TOOL_RACK, 100);
