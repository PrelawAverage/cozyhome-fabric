...
public class SofaBlockEntity extends BlockEntity implements LootableInventory, SingleStackInventory.SingleStackBlockEntityInventory {
    ...
    public ItemStack asStack() {
        ItemStack itemStack = this.getCachedState().getBlock().asItem().getDefaultStack();
