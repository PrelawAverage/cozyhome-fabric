...
public class DyeableChairBlock extends AbstractDyeableBlock implements Waterloggable, TuckableBlock, SeatBlock {
    ...
    public static final BooleanProperty COVERED = ModProperties.COVERED;
    ...
    protected ItemActionResult onUseWithItem(ItemStack stack, BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if ((stack.getItem() instanceof DyeItem)) {
            ...
            if (TuckableBlock.isFacingDirection(state, world, pos)) {
                ItemActionResult actionResult = TuckableBlock.tryTuck(state, world, pos, player);
                if (!actionResult.equals(ItemActionResult.PASS_TO_DEFAULT_BLOCK_INTERACTION)) return actionResult;
            } else {
                return super.onUseWithItem(stack, state, world, pos, player, hand, hit);
            }
    ...
    protected void appendProperties(StateManager.Builder<Block, BlockState> builder) {
        builder.add(ROTATION, TUCKED, WATERLOGGED, COVERED);
    }
