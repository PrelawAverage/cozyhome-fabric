package net.luckystudio.cozyhome.block.custom.includes_liquid;
...
public class FountainBlock extends AbstractAllSidesConnectingBlock implements AllSidesConnectingBlock {
