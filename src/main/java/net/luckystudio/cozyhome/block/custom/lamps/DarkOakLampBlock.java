...
public class DarkOakLampBlock extends AbstractLampBlock {
    public static final MapCodec<DarkOakLampBlock> CODEC = createCodec(DarkOakLampBlock::new);
    ...
    public DarkOakLampBlock(Settings settings) {
        super(settings);
    }
