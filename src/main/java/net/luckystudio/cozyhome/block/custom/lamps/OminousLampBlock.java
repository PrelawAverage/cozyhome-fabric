...
public class OminousLampBlock extends AbstractLampBlock {
    ...
    public static final VoxelShape TOP_PIECE = Block.createCuboidShape(3, 2, 3, 13, 8, 13);
    public static final VoxelShape BOTTOM_PIECE = Block.createCuboidShape(5, 0, 5, 11, 2, 11);
    ...
    public OminousLampBlock(Settings settings) {
        super(settings);
    }
