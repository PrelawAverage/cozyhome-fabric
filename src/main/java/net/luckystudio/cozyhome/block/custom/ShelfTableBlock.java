...
public class ShelfTableBlock extends AbstractAllSidesConnectingBlock implements Waterloggable {
    ...
    public static final VoxelShape NORTH_SOUTH = VoxelShapes.union(TOP_PIECE, BOTTOM_PIECE);
    public static final VoxelShape EAST_WEST = VoxelShapes.union(TOP_PIECE, BOTTOM_PIECE);
    ...
    public ShelfTableBlock(Settings settings) {
        super(settings);
    }
