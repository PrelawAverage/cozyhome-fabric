...
import net.luckystudio.cozyhome.block.block_entity.clocks.GrandfatherClockBlockEntityRenderer;
import net.luckystudio.cozyhome.block.block_entity.clocks.GrandfatherClockModel;
import net.luckystudio.cozyhome.block.block_entity.clocks.WallClockBlockEntityRenderer;
import net.luckystudio.cozyhome.block.block_entity.clocks.WallClockModel;
import net.luckystudio.cozyhome.block.block_entity.couch.CouchBlockEntityRenderer;
import net.luckystudio.cozyhome.block.block_entity.couch.CouchCushionModel;
import net.luckystudio.cozyhome.block.block_entity.sofa.SofaBlockEntityRenderer;
import net.luckystudio.cozyhome.block.block_entity.sofa.SofaCushionModel;
import net.luckystudio.cozyhome.block.block_entity.sofa.SofaModel;
import net.luckystudio.cozyhome.block.block_entity.telescope.TelescopeBlockEntityRenderer;
import net.luckystudio.cozyhome.block.block_entity.telescope.TelescopeModel;
...
import net.luckystudio.cozyhome.block.block_entity.drawer.DrawerScreen;
import net.luckystudio.cozyhome.block.block_entity.drawer.DrawerScreenHandler;
import net.luckystudio.cozyhome.block.block_entity.storage_counter.StorageCounterScreen;
import net.luckystudio.cozyhome.block.block_entity.storage_counter.StorageCounterScreenHandler;
